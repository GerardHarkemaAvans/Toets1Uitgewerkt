...
from toets_factory_states.srdf_state_to_moveit import SrdfStateToMoveit as toets_factory_states__SrdfStateToMoveit
...
from toets_factory_states.control_feeder_state import ControlFeederState
...
class PickpartfromconveyorSM(Behavior):
	'''
	This is a behavior for the toets factory simulation that picks a part from the conveyor belt using robot1
	'''
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Move Robot 1 Home',
										toets_factory_states__SrdfStateToMoveit(config_name='R1Home', move_group=pick_group, action_topic='/move_group', robot_name=""),
			...
			OperatableStateMachine.add('Move to pick',
										toets_factory_states__MoveitToJointsDynState(move_group=pick_group, offset=0.0, tool_link=gripper1, action_topic='/move_group'),
			...
			OperatableStateMachine.add('Locate part',
										DetectPartCameraState(ref_frame='robot1_base', camera_topic='/toets/logical_camera_1', camera_frame='logical_camera_1_frame'),
