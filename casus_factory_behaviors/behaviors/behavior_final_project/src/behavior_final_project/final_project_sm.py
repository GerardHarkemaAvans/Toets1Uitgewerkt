...
from casus_factory_states.srdf_state_to_moveit import SrdfStateToMoveit
from casus_factory_states.compute_grasp_state import ComputeGraspState
from casus_factory_states.moveit_to_joints_dyn_state import MoveitToJointsDynState
from casus_factory_states.control_feeder_state import ControlFeederState
from casus_factory_states.vacuum_gripper_control_state import VacuumGripperControlState
from casus_factory_states.locate_factory_device_state import LocateFactoryDeviceState
from casus_factory_states.detect_part_camera_state import DetectPartCameraState
from flexbe_states.subscriber_state import SubscriberState
from casus_factory_states.set_conveyor_power_state import SetConveyorPowerState
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Locate Part Camera1',
										DetectPartCameraState(ref_frame='robot1_base', camera_topic='/casus/logical_camera_1', camera_frame='logical_camera_1_frame'),
