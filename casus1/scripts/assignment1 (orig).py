...
# Assignment 1 for casus1: In this assignment you will subscribe to the topic that
...
import rospy
from casus_msgs.msg import <write-your-code-here-Part1>, <write-your-code-here-Part3>
