...
#include "casus_gazebo/plugins/ROSLogicalCameraPlugin.hh"

#include "casus_gazebo/plugins/ARIAC.hh"
#include "casus_gazebo/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<casus_gazebo::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
    ...
    casus_gazebo::LogicalCameraImage imageMsg;
