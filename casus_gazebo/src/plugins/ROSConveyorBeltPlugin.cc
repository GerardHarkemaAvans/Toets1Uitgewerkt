 ...
 *
*/
#include "casus_gazebo/plugins/ROSConveyorBeltPlugin.hh"
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  casus_gazebo::ConveyorBeltControl::Request, casus_gazebo::ConveyorBeltControl::Response> & event)
{
  const casus_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  casus_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
