...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "casus_gazebo/plugins/ROSVacuumGripperPlugin.hh"
#include "casus_gazebo/VacuumGripperControl.h"
#include "casus_gazebo/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    casus_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  casus_gazebo::VacuumGripperControl::Request &_req,
  casus_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  casus_gazebo::VacuumGripperState msg;
