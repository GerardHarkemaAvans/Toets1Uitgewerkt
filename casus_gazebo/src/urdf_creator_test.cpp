#include <ros/ros.h>
#include "casus_gazebo/urdf_creator.h"
...
int main(int argc, char **argv)
{
  ...
  pnh.param<std::string>("mesh_resource", mesh_resource, "package://casus_gazebo/meshes/conveyor_objects/gear.stl");
  ...
  std::string parsed_xml = casus::simulation::createObjectURDF("gear", mesh_resource);
  ...
  srv.request.robot_namespace = "casus";
