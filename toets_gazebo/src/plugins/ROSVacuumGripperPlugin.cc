...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "toets_gazebo/plugins/ROSVacuumGripperPlugin.hh"
#include "toets_gazebo/VacuumGripperControl.h"
#include "toets_gazebo/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    toets_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  toets_gazebo::VacuumGripperControl::Request &_req,
  toets_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  toets_gazebo::VacuumGripperState msg;
