 ...
 *
*/
#include "toets_gazebo/plugins/ROSConveyorBeltPlugin.hh"
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  toets_gazebo::ConveyorBeltControl::Request, toets_gazebo::ConveyorBeltControl::Response> & event)
{
  const toets_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  toets_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
