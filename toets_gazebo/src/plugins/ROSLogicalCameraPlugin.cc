...
#include "toets_gazebo/plugins/ROSLogicalCameraPlugin.hh"

#include "toets_gazebo/plugins/ARIAC.hh"
#include "toets_gazebo/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<toets_gazebo::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
    ...
    toets_gazebo::LogicalCameraImage imageMsg;
